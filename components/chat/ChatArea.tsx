                ...
                <div className="absolute bottom-0 left-0 right-0 p-2 sm:p-4 pointer-events-none z-10">
                    <div className="max-w-4xl mx-auto pointer-events-auto">
                        {analysisSteps && analysisSteps.length > 0 ? (
                            ...
                            <div className="flex flex-col items-center justify-center p-6 glass rounded-2xl shadow-[0_0_50px_-12px_rgba(181,173,160,0.2)] animate-fade-in border-t border-cyan-500/20">
