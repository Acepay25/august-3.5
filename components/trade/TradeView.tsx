...
import { fetchMarkIndex, fetchMarketData, fetchDerivativesData } from '../../services/analysis/MarketDataService';
...
const SYMBOLS = ['BTCUSDT', 'ETHUSDT', 'SOLUSDT', 'DOGEUSDT', 'XRPUSDT', 'BNBUSDT', 'ADAUSDT', 'AVAXUSDT'];
...
const TradeView: React.FC<TradeViewProps> = ({ providers, selectedChatModel, onSelectChatModel }) => {
        ...
        <div className="flex h-full min-h-0 flex-col bg-zinc-950" data-testid="trade-view">
            ...
            <div className="flex min-h-0 flex-1 flex-col lg:flex-row">
                <div className="min-h-[420px] flex-1 lg:min-h-0">
                    <TradingChart symbol={symbol} interval={interval} onIntervalChange={setInterval_} />
                </div>
