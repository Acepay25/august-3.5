        ...
        >
            {hasBacktestResults ? (
                <div className="space-y-4">
                    ...
                    {/* Verdict */}
                    <div className={`p-3 rounded-xl text-center text-ui-dense font-medium ${hasStrongEdge
                ...
                <div className="text-center py-4">
                    ...
                    <div className="text-ui-dense text-zinc-500 mb-1">Requires 3+ logged trades with similar patterns</div>
